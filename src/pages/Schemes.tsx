      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl space-y-6">
        ...
        >
          {filteredSchemes.map((scheme, index) => (
            ...
            >
              <Card className="p-6 h-full flex flex-col hover:shadow-xl transition-all duration-300 hover:scale-[1.01] bg-gradient-to-br from-card via-card to-primary/5 border-2">
                {/* Header */}
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <Badge className={`${getStatusColor(scheme.status)} font-semibold text-xs`}>
                        {scheme.status}
                      </Badge>
                    </div>
                  </div>
                  <Button
                    ...
                    className="h-9 w-9 hover:bg-success/10 shrink-0"
                  >
                ...
                <div className="mb-3 p-3 bg-warning/10 rounded-lg border border-warning/20">
                  <p className="text-xs font-semibold text-warning mb-1 uppercase tracking-wide">Key Benefit</p>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  <div className="p-3 bg-muted/30 rounded-lg">
                    ...
                    <p className="text-sm font-medium">{scheme.location}</p>
                  </div>
                  <div className="p-3 bg-muted/30 rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
